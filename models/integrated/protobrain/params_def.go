			...
			"Network": &params.Sheet{
				...
				{Sel: "TRCLayer", Desc: "",
					Params: params.Params{ //LEAVE TRCLAYER alone except for trc.drivescale
						"Layer.TRC.DriveScale":   "0.15", // 10  .3 - .05
				...
				{Sel: "#SMA", Desc: "",
					Params: params.Params{
						...
						"Layer.Act.Noise.Ge": "0.001", //10 .0005 - .01
						"Layer.Act.Noise.Gi": "0.001", //10 .0005 - .01
					}},
				{Sel: "#SMAP", Desc: "pulv",
					Params: params.Params{
				...
				{Sel: "Prjn", Desc: "norm and momentum on is critical, wt bal not as much but fine",
					Params: params.Params{
						...
						"Prjn.SWt.Adapt.Lrate":        "0.001", // 8 [.0001 - .01]  0.001 seems to work fine, but .001 maybe more reliable
						"Prjn.SWt.Adapt.DreamVar":     "0.01",  // 8 [0 - .05]  0.01 is just tolerable
						...
						"Prjn.Learn.XCal.PThrMin":     "0.05", // 8 [0.01 - .1]  .05 > .01 for PCA for SynSpk, bad for NeurSpk
						"Prjn.Learn.XCal.LrnThr":      "0.05", // 8 [0.01 - .1] .05 > .01 here but not smaller nets -- should match NeurCa.LrnThr 0.05 also good
					}},
				{Sel: ".Back", Desc: "top-down back-projections MUST have lower relative weight scale, otherwise network hallucinates",
					Params: params.Params{
						"Prjn.PrjnScale.Rel": "0.1", //10 [.05 - .3]
					}},
				{Sel: ".CTBack", Desc: "deep top-down -- stronger",
					Params: params.Params{
						"Prjn.PrjnScale.Rel": "0.2", //10 [.05 - .3] 0.2 > 0.5 - .ctback ad acttoct should have shared hyperparam
					}},
				...
				{Sel: ".Inhib", Desc: "inhibitory projection",
					Params: params.Params{
						...
						"Prjn.Learn.Lrate.Base": "0.001", // 9 [.0001 - .01] .0001 > .001 -- slower better!
						"Prjn.SWt.Init.Var":     "0.0",
						"Prjn.SWt.Init.Mean":    "0.1",
						"Prjn.SWt.Init.Sym":     "false",
						"Prjn.SWt.Adapt.On":     "false",
						"Prjn.PrjnScale.Abs":    "0.3", // 9 [0 - 0.5] .1 = .2, slower blowup
				...
				{Sel: ".FmPulv", Desc: "default for pulvinar",
					Params: params.Params{
						"Prjn.PrjnScale.Rel": "0.1", //10 [.05 - .3] .1 > .2
					}},
